def findDecision(obj): #obj[0]: Historia do credito, obj[1]: Divida, obj[2]: Garantias, obj[3]: Renda Anual
	# {"feature": "Renda Anual", "instances": 11, "metric_value": 0.3636, "depth": 1}
	if obj[3] == '>35000':
		# {"feature": "Historia do credito", "instances": 6, "metric_value": 0.2222, "depth": 2}
		...
		# {"feature": "Divida", "instances": 2, "metric_value": 0.0, "depth": 2}
		if obj[1] == 'Alta':
			return 'Alto'
		elif obj[1] == 'Baixa':
			return 'Moderado'
